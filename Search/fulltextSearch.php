                                                ...
                                                <div class='col-3 products'>
                                                    <div class='card text-left'>
                                                        ...
                                                        <div class='card-body'>
                                                            ...
                                                            <div class='display'>
                                                                <button class='btn btn-outline-success'><a class='nav-link' href='../Cart/cart.php?id={$row['id']}'>Add</a></button>
                                                                <button class='btn btn-outline-success'><a class='nav-link' href='../admin/dist/details.php?id={$row['id']}'>Detail</a></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>";
