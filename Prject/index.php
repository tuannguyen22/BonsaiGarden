    ...
    <div class="container">
      ...
      <hr style="width: 75%">
        ...
        <?php
          ...
          {
            $sql = "SELECT status1 from orders where productId='$id[$i]'";
            $result = mysqli_query($conn, $sql);
        ...
        if( $status[$index] == 0 || $status[$index] == 1 || $status[$index] == 2 ||  $status[$index]== 3 ||  $status[$index] == 4){
          //$status = "";
          echo '
          <div class="card">
            ...
            <div class="wrapper row">
              <div class="preview col-md-6">
                <div class="preview-pic tab-content">
                  <div class="tab-pane active" id="pic-1"><img src="'.$product_view['image'].'" /></div>
                </div>
              </div>
              <div class="details col-md-8">
                <div class="rating">
                  <span class="product-title" style="font: size 25px;">'.$product_view['name'].'</span><br>
                  <span class="review-no">'.$product_view['content'].'</span>
                </div>
                
                <h5 class="sizes">Sizes:
                  <span class="size" data-toggle="tooltip" title="small">'.$product_view['type'].'</span>
                </h5>
                    ...
                    <hr style="width: 75%">
                    <div class="action">
                        <span>'.$product_view['quantity'].'</span>
                        <span style="margin-left: 65%;"><i class="fa fa-dollar" style="font-size:30px;color:red"></i> '.$product_view['price'].'</span>
                    </div>
                    <hr style="width: 75%">
                    <div class="action">
                        <span style="color:blue"><i class="fas fa-truck" style="font-size:30px;color:green; margin-left: -25px;"></i>'.$status[$index].'<span>
                        <span style="margin-left: 60%;"><i class="fas fa-angle-right" style="font-size:24px"></i></span>
                    </div>
                    <div class="action">
                        <span class="stars" style="margin-right: 54%">
